                  ...
                  child: Container(
                    ...
                    child: ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        final text =
                            _pretty ? _prettyText(entry.text) : entry.text;
                        return Padding(
  ...
  Color _color(SocketConsoleKind kind) {
    ...
    return switch (kind) {
      SocketConsoleKind.incoming =>
        isDark ? const Color(0xFF569CD6) : const Color(0xFF005CC5), // Blue
      SocketConsoleKind.outgoing =>
        isDark ? const Color(0xFF4EC9B0) : const Color(0xFF22863A), // Green
      SocketConsoleKind.error =>
        isDark ? const Color(0xFFF14C4C) : const Color(0xFFD73A49), // Red
      SocketConsoleKind.info =>
        isDark ? const Color(0xFFCCCCCC) : const Color(0xFF6A737D), // Gray
    };
  }
}
